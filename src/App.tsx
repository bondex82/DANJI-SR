    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-brand-green text-white p-4 flex items-center justify-between md:hidden shadow-lg">
        <div className="flex items-center gap-2">
          <img 
            src={mainCandidate?.candidate_picture || "https://picsum.photos/seed/election/100/100"} 
            alt="Logo" 
            className="w-8 h-8 rounded-full border border-white object-cover bg-white"
            referrerPolicy="no-referrer"
          />
          <span className="font-black tracking-tighter uppercase text-sm">DANJI SS 2027 Situation Room</span>
        </div>
        <button 
          ...
          <div className="p-6 bg-brand-green text-white">
            <div className="flex items-center gap-3 mb-2">
              <img 
                ...
                referrerPolicy="no-referrer"
              />
              <h2 className="font-bold leading-tight">DANJI SS 2027 Situation Room</h2>
            </div>
            ...
            {user ? (
              <div className="space-y-3">
                ...
                <button 
                  ...
                  className="w-full flex items-center gap-3 px-4 py-2 text-brand-yellow hover:bg-yellow-50 rounded-lg transition-colors font-medium text-sm"
                >
